    ...
    def __getitem__(self, idx):
        ...
        if self.split == "train":
            if case.split('_')[0]!='new':
                h5f = h5py.File(self._base_dir_data +f"/data/FL/FL_slices/{case}.h5", "r")
            else:
                h5f = h5py.File(self._base_dir_data + f"/data/FL/FL_unlabel_silces/{case}.h5", "r")
        else:
            h5f = h5py.File(self._base_dir_data + f"/data/FL/FL_slices/{case}.h5", "r")
        image = h5f["image"][:]
        label = h5f["label"][:]
...
class TwoStreamBatchSampler(Sampler):
    ...
    def __init__(self, primary_indices, secondary_indices, batch_size, secondary_batch_size):
        ...
        # print(f'batch_size={batch_size},primary_batch_size={self.primary_batch_size}')
    ...
    def __iter__(self):
        ...
        # print(f'secondary_iter={secondary_iter}')
        return (
...
if __name__ == '__main__':
    if __name__ == '__main__':
        a, b = get_dataset('huaxiFGOnly', 1, [256, 256])
        # print(len(a[0][0]))
        # print(len(b))
